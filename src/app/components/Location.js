...
const Location = () => {
  ...
  return (
    <div className="bg-gray-800 p-4 rounded-lg shadow-md mb-4">
        <label htmlFor="location-dropdown" className="block text-lg font-bold text-gray-300 mb-2">
        Choose a Location:
      </label>
      <select id="location-dropdown" value={selectedLocation} onChange={handleChange}
